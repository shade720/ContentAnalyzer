...
public static class Program
{
    public static void Main()
    {
        ...
        var j = 1;
        var flag = true;
        client.Auth(8046073, "rvSXQVVe9QI7Xq1hjKNm", "041d6301041d6301041d6301940467a6f80041d041d630165c7f58fa7908b5e485a8377");
        var i = 0;
        while (i < 120)
        {
            var postId = client.GetPostId((ulong)j, -29573241);
